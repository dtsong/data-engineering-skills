...
- SQL transforms in dbt: hand off to `dbt-skill`
- DLT pipeline config: hand off to `integration-patterns-skill`
- Kafka/Flink streaming: hand off to `streaming-data-skill`
- Dagster/Airflow orchestration: hand off to `data-orchestration-skill`
