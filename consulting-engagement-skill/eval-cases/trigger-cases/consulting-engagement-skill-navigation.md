# Navigation Eval Cases — consulting-engagement-skill
...
**Should Read:**
- `consulting-engagement-skill/SKILL.md` (Engagement Lifecycle section)
**Should NOT Read:**
- `consulting-engagement-skill/references/security-tiers.md`
- `consulting-engagement-skill/references/schema-profiling.md`
- `consulting-engagement-skill/references/engagement-scaffold.md`
- `consulting-engagement-skill/references/deliverables.md`
**Observation Points:**
...
**Should Read:**
- `consulting-engagement-skill/SKILL.md` (Deliverable Generation section for overview)
- `consulting-engagement-skill/references/deliverables.md` (full structure, automation, templates)
**Should NOT Read:**
- `consulting-engagement-skill/references/security-tiers.md`
- `consulting-engagement-skill/references/schema-profiling.md`
- `consulting-engagement-skill/references/engagement-scaffold.md`
...
**Expected Navigation:** SKILL.md only
**Should Read:**
- `consulting-engagement-skill/SKILL.md` (Security Tier Selection section)
**Should NOT Read:**
- `consulting-engagement-skill/references/security-tiers.md` (not needed for basic selection)
...
**Should Read:**
- `consulting-engagement-skill/SKILL.md` (Security Posture section for consulting-specific tiers)
- `shared-references/data-engineering/security-tier-model.md` (organization-level tier model)
**Should NOT Read:**
- `consulting-engagement-skill/references/security-tiers.md` (procedural detail, not the organizational model)
- `consulting-engagement-skill/references/schema-profiling.md`
- `consulting-engagement-skill/references/deliverables.md`
**Observation Points:**
